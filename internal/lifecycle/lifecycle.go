...
// graceful shutdown management for the MagicDev MCP server.
//
...
func lockDir() (string, error) {
	...
	dir := filepath.Join(cacheDir, "mcp-server-magicdev")
...
func killProcess(pid int) {
	...
	slog.Info("killing stale magicdev instance", "pid", pid)
